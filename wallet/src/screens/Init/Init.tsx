...
export default function Init() {
  ...
  const aspReady = true // allow wallet creation even if ASP unreachable (SatsPath dev mode)
  ...
  useEffect(() => {
    setError(false) // allow wallet creation even if ASP unreachable (SatsPath dev mode)
  }, [aspInfo.unreachable])
